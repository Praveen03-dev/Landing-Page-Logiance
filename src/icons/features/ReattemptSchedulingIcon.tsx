...
interface ReattemptSchedulingIconProps {
  width?: number;
  height?: number;
  isHovered?: boolean;
}

const ReattemptSchedulingIcon: React.FC<ReattemptSchedulingIconProps> = ({ 
  width = 28, 
  height = 28, 
  isHovered = false 
}) => {
...
export default ReattemptSchedulingIcon;